...
const Register = () => {
    ...
    return (
        <div className="relative z-0 min-h-screen w-full overflow-hidden bg-cover bg-center" style={{ backgroundImage: `url(${bg6})` }}>
                ...
                <div className="flex flex-col items-center gap-2 w-full md:w-1/2 max-w-[500px] py-8 bg-white rounded-xl shadow-lg">
                    ...
                    <div className="flex flex-col items-center w-full ">
                        <div className="flex flex-col items-center w-full gap-1 mb-2">
                            ...
                            <Text className="text-[15px] font-normal text-center" style={{ fontFamily: 'Merienda, cursive' }}>
                    ...
                    <div className="flex flex-col items-center w-full">
                        <Form layout="vertical" form={form} className="w-[380px] sm:w-[400px]" onFinish={onFinish}>
                            <Form.Item name="email" label="Email" className="custom-label"
                                rules={[
                                    { required: true, message: "Email is required!" },
                                    { type: "email", message: "Email is invalid!" },
                                ]}
                            >
                                <Input prefix={<MailOutlined />} placeholder="Email" size="large" maxLength={100} autoComplete="off" className="w-full custom-input rounded-none" />
                            </Form.Item>

                            <Form.Item name="password" label="Password" className="custom-label" rules={[{ validator: passwordFieldValidation, required: true }]}>
                                <Input.Password prefix={<LockOutlined />} size="large" placeholder="Password" maxLength={60} className="w-full custom-input" />
                            </Form.Item>
                                ...
                                rules={[
                                    ({ getFieldValue }) => ({
                                        validator(_, value) {
                                            ...
                                            if (!getFieldValue("scrolledToBottom")) return Promise.reject("Please scroll and read all terms");
                            ...
                            >
                                <Checkbox disabled={!form.getFieldValue("scrolledToBottom")}>
                                    I agree to the <span className="text-textColorTwo cursor-pointer underline" onClick={() => setModalVisible(true)}>Terms & Privacy Policy</span>
                                </Checkbox>
                            </Form.Item>

                            <Form.Item>
                                <div className="flex justify-center">
                                    <Button type="primary" htmlType="submit" className="w-full md:w-[300px] h-[45px] text-base md:text-lg rounded-full text-white font-bold transition-all duration-300 ease-in-out bg-gradient-to-r from-[#6EE7B7] via-[#3FBFA8] to-[#2CA58D] hover:from-[#3FBFA8] hover:via-[#2CA58D] hover:to-[#207F6A]" loading={loading}>
                                        Sign Up
                                    </Button>
                                </div>
                            </Form.Item>
                        ...
                        <Form>
                            ...
                            <Form.Item>
                                <div className="flex justify-center">
                                    <Button type="primary" className="google_btn flex items-center gap-2" onClick={googleAuth}>
                            ...
                            <Text className="block text-center text-sm md:text-base text-textColorOne">
                                Already have an account? <span className="text-textColorTwo cursor-pointer" onClick={() => navigate("/sign-in")}>Sign In</span>
                            </Text>
                        </Form>
                    </div>
                </div>
            ...
            >
                ...
                >
                    ...
                    <p>hguhsgfds yugeyfuw seufen ssesnds bdnsye wned  syfsyufysu fshghfsgdf gsdhsg </p>
                    <p>hguhsgfds yugeyfuw seufen ssesnds bdnsye wned  syfsyufysu fshghfsgdf gsdhsg </p>
                    <p>hguhsgfds yugeyfuw seufen ssesnds bdnsye wned  syfsyufysu fshghfsgdf gsdhsg </p>
                    ...
                    <p><em>Scroll to the bottom to enable acceptance.</em></p>
                </div>
            </Modal>
