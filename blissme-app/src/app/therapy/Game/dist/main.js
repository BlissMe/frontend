    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("".concat(API_URL, "/start"), { method: 'POST' })];
                case 1:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    console.error('Failed to start new game:', error_1);
                    return [3 /*break*/, 4];
...
function handleGuess() {
    return __awaiter(this, void 0, void 0, function () {
        var guessValue, response, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("".concat(API_URL, "/guess"), {
                            method: 'POST',
                ...
                case 4:
                    ...
                    console.error('Failed to handle guess:', error_2);
                    return [3 /*break*/, 5];
