...
import { endCurrentSession } from "../../services/ChatMessageService"; // Make sure this path is correct
import { useNotification } from "../../app/context/notificationContext"; // Ensure this exists
